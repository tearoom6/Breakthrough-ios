...
struct  UseSystemDefaultValues_t3736939686 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UseSystemDefaultValues_t3736939686, ___value___1)); }
