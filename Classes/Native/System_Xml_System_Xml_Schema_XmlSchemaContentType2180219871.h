...
struct  XmlSchemaContentType_t2180219871 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaContentType_t2180219871, ___value___1)); }
