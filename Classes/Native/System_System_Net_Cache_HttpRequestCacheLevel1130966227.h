...
struct  HttpRequestCacheLevel_t1130966227 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HttpRequestCacheLevel_t1130966227, ___value___1)); }
