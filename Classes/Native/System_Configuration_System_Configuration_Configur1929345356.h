...
struct  ConfigurationSaveMode_t1929345356 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationSaveMode_t1929345356, ___value___1)); }
