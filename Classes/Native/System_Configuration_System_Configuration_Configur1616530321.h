...
struct  ConfigurationLockType_t1616530321 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationLockType_t1616530321, ___value___1)); }
