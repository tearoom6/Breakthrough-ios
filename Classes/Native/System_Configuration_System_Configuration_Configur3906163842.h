...
struct  ConfigurationElementCollectionType_t3906163842 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationElementCollectionType_t3906163842, ___value___1)); }
