...
struct  XmlSchemaValidationFlags_t87720602 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(XmlSchemaValidationFlags_t87720602, ___value___1)); }
