...
struct  ConfigurationAllowExeDefinition_t956581384 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConfigurationAllowExeDefinition_t956581384, ___value___1)); }
