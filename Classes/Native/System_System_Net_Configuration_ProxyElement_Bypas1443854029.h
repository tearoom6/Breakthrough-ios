...
struct  BypassOnLocalValues_t1443854029 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(BypassOnLocalValues_t1443854029, ___value___1)); }
