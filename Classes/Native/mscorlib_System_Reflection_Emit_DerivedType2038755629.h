...
struct  DerivedType_t2038755629  : public Type_t
{
public:
...
public:
	inline static int32_t get_offset_of_elementType_8() { return static_cast<int32_t>(offsetof(DerivedType_t2038755629, ___elementType_8)); }
